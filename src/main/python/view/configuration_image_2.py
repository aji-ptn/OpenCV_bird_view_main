class ConfigurationImage2:
    ...
    def connect_action(self):
        # ================== intrinsic parameter ==================
        self.view_controller.main_ui.doubleSpinBox_fx_1.valueChanged.connect(self.change_intrinsic_from_ui)
        self.view_controller.main_ui.doubleSpinBox_fy_1.valueChanged.connect(self.change_intrinsic_from_ui)
        self.view_controller.main_ui.doubleSpinBox_icx_1.valueChanged.connect(self.change_intrinsic_from_ui)
        self.view_controller.main_ui.doubleSpinBox_icy_1.valueChanged.connect(self.change_intrinsic_from_ui)
        self.view_controller.main_ui.spinBox_width_1.valueChanged.connect(self.change_intrinsic_from_ui)
        self.view_controller.main_ui.spinBox_height_1.valueChanged.connect(self.change_intrinsic_from_ui)
